 ...
 *
*/
class UkrgbViewskillmanager extends JViewLegacy
{
	protected $items;
	...
	public function display($tpl = null)
	{
		...
		UkrgbHelper::addSubmenu('skillmanager');	
	...
	protected function addToolbar()
	{
		...
		if ($canDo->get('core.edit.state')) {
			...
			JToolbarHelper::publish('skillmanager.publish', 'JTOOLBAR_PUBLISH', true);
			JToolbarHelper::unpublish('skillmanager.unpublish', 'JTOOLBAR_UNPUBLISH', true);

			JToolbarHelper::archiveList('skillmanager.archive');
			JToolbarHelper::checkin('skillmanager.checkin');
		}
		if ($state->get('filter.state') == -2 && $canDo->get('core.delete'))
		{
			JToolbarHelper::deleteList('', 'skillmanager.delete', 'JTOOLBAR_EMPTY_TRASH');
		} elseif ($canDo->get('core.edit.state'))
		{
			JToolbarHelper::trash('skillmanager.trash');
		}
		// Add a batch button
		...
		JToolbarHelper::help('JHELP_COMPONENTS_SKILLMANAGER_LINKS');
